...
import { getPolicyDetails, resetPolicyDetails, saveNewPolicyDetails } from '../actions/actionIndex';
...
const PolicySearchDashboard = () =>{
    ...
    return(<div>
        ...
        <h1 className='display-4'>Policy Search Dashboard</h1>
        ...
        <div className='container'>
            ...
            <div className='row align-items-center' style={{padding: '20px 0'}}>
                <div className='col-lg-8 offset-lg-2 col-10 col-sm-6'>
                    ...
                    onClick={handleClick}
                    />
                    <p id="errorMessage" disabled className="text-danger display-6"><em>{receivedPolicyDetailsErrorMessage}</em></p>
                </div>
            </div>
            {receivedPolicyDetails&&<div className='row align-items-center'>
                <div className='col-lg-8 offset-lg-2 col-10 col-sm-6'>
                    ...
                    <h1 className='h6' style={{marginBottom:'20px'}}><mark><u><em>{`Policy details of policy-Id : ${receivedPolicyDetails.policyId}`}</em></u></mark></h1>
                        ...
                        <div className="form-row ">
                            <div className="col-md-4 mb-3">
                                <div className="form-check">
                                    ...
                                    <label className="labelstyles" className="form-check-label" htmlFor="BIL">Bodily Injury Liability</label>
                                </div>
                            </div>
                            <div className="col-md-4 mb-3">
                                <div className="form-check">
                                    <input disabled className="form-check-input" type="checkbox" checked={receivedPolicyDetails.personalInjuryProtection} id="PIP"/>
                                    <label className="labelstyles" className="form-check-label" htmlFor="PIP">Personal Injury Protection</label>
                                </div>
                            </div>
                            <div className="col-md-4 mb-3">
                                <div className="form-check">
                                    <input disabled className="form-check-input" type="checkbox" checked={receivedPolicyDetails.propertyDamageLiability} id="PDL"/>
                                    <label className="labelstyles" className="form-check-label" htmlFor='PDL'>Property Damage Liability</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <span id="errorMessage" disabled className="text-danger display-6"><em>{savePolicyDetailsErrorMessage}</em></span>
                        <span id="successMessage" disabled className="text-success display-6"><em>{savePolicyDetailsSuccessMessage}</em></span>
                    </form>
                </div>
            </div>}
        </div>
